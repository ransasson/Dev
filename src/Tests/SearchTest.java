...
public class SearchTest {
	...
	public void searchByKindArrivalTest() {
		...
		assertEquals(expectedResult.toString(),airport.searchFlights(false,true,false,false,false,false,false,false,false,false,false,false,false,"Arrivals","Israir","","","","",""));
	}
